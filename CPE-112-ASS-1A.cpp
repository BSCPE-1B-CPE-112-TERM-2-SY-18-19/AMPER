Bryan Amper BSCPE - 1B

What is iostream?
-	C++ header. The header file declares a set of functions for standard Input/Output. It also defines I/O stream objects such as cin , cout , clog etc
What is inside of Iostream?
...
/** @file include/iostream*  This is a Standard C++ Library header.*///
...
/** *  @name Standard Stream Objects  * *  The &lt;iostream&gt; 
